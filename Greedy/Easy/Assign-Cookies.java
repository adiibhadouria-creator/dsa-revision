 ...
 *
 * Notes:
 * Hashmap wont work here because , cant iterate in it in sorted way thus sorting the array is the optimal aproach
 */

class Solution {
    public int findContentChildren(int[] g, int[] s) {
        //Sort both the array then use two pointers
        int count = 0;
        Arrays.sort(g);
        Arrays.sort(s);
        int i=0,j=0;
