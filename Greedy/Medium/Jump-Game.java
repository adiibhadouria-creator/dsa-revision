 ...
 *
 * Notes:
 * greedy for choosing the maximum jump and checking if i can reach the end
 */

class Solution {
    public boolean canJump(int[] nums) {
        //Greediness -> choosing the max jump
        // I tried to jump the maximum and seeing if I had reached the end
        int n = nums.length;
