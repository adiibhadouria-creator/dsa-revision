 ...
 * Difficulty: Easy
 * Topic: LeetCode Daily > Geometry
 * Time complexity: O(1)
 * Space complexity: O(1)
 * Solved: 2026-09-19
 * URL: https://leetcode.com/problems/circle-and-rectangle-overlapping/?envType=daily-question&envId=2026-09-19
 *
 * Problem statement:
 ...
 *
 * Notes:
 * find closest point to the center then check if distance between them is lesser than or equal to radius
 */
